...
let Signup = ()=>{
   ...
   async function handleLogin() {
    ...
    'https://www.productionapp.com/' : 'http://localhost:4000/'
        ...
        let data;
        await axios.post( apiBase + "auth/signup" ,  obj).then((res)=>{
            data = res;
        }).catch((err)=>{
            console.log(err);
        })
    ...
    return (
            ...
            <div className="form-container">
                ...
                <div className="loginBox">
                    ...
                    <div className='otherOption'>
                        <button className="otherbtns form-button" type="submit" onClick={handleLogin} >
                            Sign Up
        ...
        <div className="left">
            <img src="https://img.freepik.com/free-vector/sign-up-concept-illustration_114360-7885.jpg?w=740" alt="" />
        </div>
        </div>
         </>
    )
